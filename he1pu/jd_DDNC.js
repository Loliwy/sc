...
let shareCodes = ['f2197d1432e3411d829bd670817e01b7@b5f3ef0e26ca45168580aefc083041a0@086685c5f6d64d8b8f751b6f4e9dc24d@633a171106bf42e7b0acbe61537e808f@72abfb7ee84e4123ac3028cd08c0a12d@d1cd415390694b87bd21d53a85e83869@1de91324eece461488a7ac33b8718aee@a2c0714f2b344f2698cbaf956cca65ad@81abadbb2f9e4df2ab1d05739afd6698@f4a6a17069d94080a404798fa1ef3c12@0801afa8ac904cc6b8e390d5f04f2fc5@ee9a2d8a819a41ae984dde81d9bcdd43@f49888210024495a801d944e57ea6e1a@bbc8855f35344efaa3d37d8c98a6a1af@955f944d85bb4f2a92ed2628d7c35425@bdd2c316df9a46b98c6651c8cb0e2121@abff29a47bd9408988d9c2661bd8d0ca@4885610b5a0c409591e4e91ac45ba527@ff716547abb44ad7aea81b4c59da8c79'];
...
async function doTenWaterAgain() {
  ...
  if (`${jdFruitBeanCard}` === 'true' && JSON.stringify($.myCardInfoRes).match('限时翻倍')) {
    console.log(`\n您设置的是水滴换豆功能,现在为您换豆`);
    if (totalEnergy >= 100000 && $.myCardInfoRes.beanCard > 0) {
      //使用水滴换豆卡
  ...
  let overageEnergy = totalEnergy - retainWater;
         //超过的能力=总数-保留
  if (totalEnergy >= ($.farmInfo.farmUserPro.treeTotalEnergy)) {
  ...
  } else if (overageEnergy >= retainWater) {
